...
export const COPY = {
  fr: {
    ...
    popular: 'Populaire',
    perMonth: '/mois',
    freeItems: ['3 sessions / 12h', 'Mode Cours', '15 000 caractères par session', 'Français et anglais', 'Feedback structuré en 4 axes'],
    proItems: ['20 sessions / 12h', 'Mode Cours et Mode Code', '25 000 caractères par session', '11 langues de feedback', 'Historique complet', 'Support prioritaire'],
  ...
  en: {
    ...
    popular: 'Popular',
    perMonth: '/month',
    freeItems: ['3 sessions / 12h', 'Course mode', '15,000 characters per session', 'French and English', 'Structured feedback in 4 axes'],
    proItems: ['20 sessions / 12h', 'Course and Code mode', '25,000 characters per session', '11 feedback languages', 'Full session history', 'Priority support'],
